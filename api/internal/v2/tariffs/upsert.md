...
| is_secondary_tariff                             | Boolean             |              | false                                  | This tariff is not the main offer of the EMP (e.g. a white label for a partner, or a regional offer).                                                                                                                 |
...
| prices.decomposition.dimension                  | String              |              | "minute"                               | Either "minute" (while charging), "parking_minute" (after charging), "kwh" or "session"                                                                                                                               |
