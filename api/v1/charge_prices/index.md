...
| station.charge_points.plug                | String        | required                          | "ccs"                                  | Type of plug at charge point. Possible values for data adapter "chargeprice": [See Supported values](../../enums.md#plugs)                                                                                                                                                                                                      |
...
| vehicle        | Relationship           | See **Duration and Energy Input**                      | `{"id": "some-uuid", type:"car" }`      | Vehicle at charge.                                                                                                                                                                                                                                                                     |
...
| branding.impression_tracking_url       | String or null  | "https://www.chargeprice.app/track" | URL to be used for tracking branding impressions. `null` if not available.                                                                                                                                                                   |
