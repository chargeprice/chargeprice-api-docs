...
| facility_details                | Array<String>     | Object                     | List of actual facilities located near the charging station.                             |
...
| facility_details.name           | Name or null      | "Burger Kind Paris"        | Name of the facility, if available. Otherwise `null`.                                                                                   |
...
```json
{
  "data": {
    ...
    "attributes": {
      ...
      "facilities": ["restaurant", "fuel_station"],
      "facility_details": [
        {
          "facility_types": ["restaurant"],
          "name": "Burger King Paris",
          "longitude": 43.345,
          "latitude": 12.443
        }
      ],
