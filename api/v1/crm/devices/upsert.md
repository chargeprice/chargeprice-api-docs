...
| disabled_notifications | Array<String> | required     | ["promotion_external_generic"]         | List of notification type keys the user has opted out of. Notifications of these types will not be sent to this device. Allowed values: "promotion_external_generic", "promotion_external_personalized", "promotion_chargeprice_premium", "product_updates" |
