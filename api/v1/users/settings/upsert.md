...
| android_purchases.product_id          | String             | required     | -                                                 | `productId`from the Google Play Stor. Currently only `premium`.                                                                                                                                                                             |
...
| android_purchases.product_id          | String       | -                                                 | `productId`from the Google Play Stor. Currently only `premium`.                                                                                                                                                 |
