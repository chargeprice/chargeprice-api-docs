...
| Parking Type     | String                 | "underground_garage"                 | The general type of parking at the charging location. [See supported values](../api/enums.md#Parking-Type)                                |
| Facilities       | Comma-separated String | "restaurant,cafe"                    | Facilities that closely located to the charging station. [See supported values](../api/enums.md#Facilities)                               |
